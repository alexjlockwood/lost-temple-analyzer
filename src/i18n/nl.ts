export const nl = {
  common: {
    description:
      'Klik of sleep de kamers en deuren hieronder om de verschillende waarschijnlijkheden te bekijken. Klik één keer op een deur om deze als open te markeren, twee keer voor gesloten en drie keer om te wissen.',
    resetGridButton: 'Raster resetten',
