export const fr = {
  common: {
    description:
      'Cliquez ou faites glisser les salles et portes en-dessous pour voir les probabilités des différents chemins. Cliquez une fois sur une porte pour la marquer comme ouverte, deux fois pour la marquer comme fermée, et trois fois pour réinitialiser la porte.',
    resetGridButton: 'Réinitialiser la grille',
