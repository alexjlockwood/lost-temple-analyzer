export const pl = {
  common: {
    description:
      'Kliknij lub przeciągnij pokoje i drzwi poniżej, aby zobaczyć prawdopodobieństwa różnych ścieżek. Kliknij drzwi raz, aby oznaczyć je jako otwarte, dwa razy, aby oznaczyć je jako zamknięte i trzy razy, aby je wyczyścić.',
    resetGridButton: 'Zresetuk kratkę',
