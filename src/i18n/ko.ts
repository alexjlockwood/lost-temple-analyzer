export const ko = {
  common: {
    description:
      '방이나 통로를 마우스로 클릭하거나 드래그하여 각기 다른 길의 존재 가능성을 확인하세요. 문을 한 번 클릭하여 열린 것으로 표시하고, 두 번 클릭하여 닫힌 것으로 표시하며, 세 번 클릭하여 지울 수 있습니다.',
    resetGridButton: '재시작',
    copyLinkButton: '주소 복사',
    copyLinkToClipboardSuccess: '링크가 클립보드에 복사되었습니다',
    copyLinkToClipboardError: '링크를 클립보드에 복사할 수 없습니다',
    possiblePaths_zero: '{{count}}개의 가능한 경로',
